...
image_dir = "C:\Users\Tissan Kugathas\Desktop\Programing\Python\AI\Neural_Algorithm_Artistic_Style-master\Images"
model_dir = "C:\Users\Tissan Kugathas\Desktop\Programing\Python\AI\Neural_Algorithm_Artistic_Style-master"
...
prep = transforms.Compose([transforms.Resize(img_size),
                           transforms.ToTensor(),
                           # CONVERT TO BGR FOR VGG NET
                           transforms.Lambda(lambda x: x[torch.LongTensor([2, 1, 0])]),
                           transforms.Normalize(mean=[0.40760392, 0.45795686, 0.48501961], std=[
                                                1, 1, 1]),  # SUBTRACT IMAGENET MEAN
                           # VGG WAS TRAINED WITH PIXEL VALUES 0-255
...
img_names = ['style_line_architecture.jpg', 'content_evening_city.jpg']
